...
这是「禹都AI解决方案助手」的产品介绍与下载页面，面向售前工作台、项目管理、技术标书、公文写作、论文导师、软件著作和国家专利等本地 AI 工作台场景。

页面基于 Vite、React 和 TypeScript 构建，包含动态产品首屏、功能介绍、界面展示、使用说明和下载区。下载区会在浏览器端请求 GitHub 最新 Release，并自动匹配 Windows 与 macOS 安装包。
